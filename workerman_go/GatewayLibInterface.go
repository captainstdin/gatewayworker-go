...
// 官方28 个接口
const (
	ConstsComponentCommandSendToAll = iota + 1
	ConstsComponentCommandSendToClient
	ConstsComponentCommandCloseClient
	ConstsComponentCommandIsOnline
	ConstsComponentCommandBindUid
	ConstsComponentCommandUnbindUid
	ConstsComponentCommandIsUidOnline
	ConstsComponentCommandGetClientIdByUid
	ConstsComponentCommandGetUidByClientId
	ConstsComponentCommandSendToUid
	ConstsComponentCommandJoinGroup
	ConstsComponentCommandLeaveGroup
	ConstsComponentCommandUngroup
	ConstsComponentCommandSendToGroup
	ConstsComponentCommandGetClientIdCountByGroup
	ConstsComponentCommandGetClientSessionsByGroup
	ConstsComponentCommandGetAllClientIdCount
	ConstsComponentCommandGetAllClientSessions
	ConstsComponentCommandSetSession
	ConstsComponentCommandUpdateSession
	ConstsComponentCommandGetSession
	ConstsComponentCommandGetClientIdListByGroup
	ConstsComponentCommandGetAllClientIdList
	ConstsComponentCommandGetUidListByGroup
	ConstsComponentCommandGetUidCountByGroup
	ConstsComponentCommandGetAllUidList
	ConstsComponentCommandGetAllUidCount
	ConstsComponentCommandGetAllGroupIdList
	ConstsComponentCommandGetAllGroupCount
)
...
type GatewayLibInterface interface {
	...
	SendToClient(client_id string, send_data []byte)
	...
	GetAllClientSessions() map[string]interface{}
